...
libbpfgo is a Go library for Linux's [eBPF](https://ebpf.io/) project. It was created for [Tracee](https://github.com/khulnasoft/tracee), our open source Runtime Security, and eBPF tracing tool, written in Go. If you are interested in eBPF and its applications, check out Tracee at Github: [https://github.com/khulnasoft/tracee](https://github.com/khulnasoft/tracee).
...
1. Embed libbpf into your Go project as a vendored dependency. This means that the libbpf code is statically linked into the resulting binary, and there are no runtime dependencies.  [Tracee](https://github.com/khulnasoft/tracee) takes this approach.
...
- [tracee-ebpf](https://github.com/khulnasoft/tracee/tree/main/cmd/tracee-ebpf) is a robust consumer of this project.
